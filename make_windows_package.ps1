...
cp $build_dir/misc_modules/phasing/Release/phasing.dll sdrpp_windows_x64/modules/
...
cp $build_dir/misc_modules/recording_scheduler/Release/recording_scheduler.dll sdrpp_windows_x64/modules/
